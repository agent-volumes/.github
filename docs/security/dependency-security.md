  ...
  dependency-review:
    ...
    steps:
      ...
      - name: 'Dependency Review'
        ...
        with:
          config-file: 'agent-volumes/.github/.github/dependency-review-config.yml@main'
```
...
jobs:
  osv:
    ...
    uses: agent-volumes/.github/.github/workflows/osv-scanner-pr-reusable.yml@<pin-sha>
```
