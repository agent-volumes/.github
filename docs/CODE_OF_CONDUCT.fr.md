...
[English](../CODE_OF_CONDUCT.md) | [한국어](CODE_OF_CONDUCT.ko.md) | [简体中文](CODE_OF_CONDUCT.zh-cn.md) | [Deutsch](CODE_OF_CONDUCT.de.md) | Français | [বাংলা](CODE_OF_CONDUCT.bn.md) | [Magyar](CODE_OF_CONDUCT.hu.md)
...
Lorsqu'un problème se produit, il est important de le notifier rapidement. Pour rapporter une possible infraction, **envoyez un e-mail à [conduct@agentvolumes.org](mailto:conduct@agentvolumes.org)**.
